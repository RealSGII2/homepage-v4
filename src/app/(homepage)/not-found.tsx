...
export default function NotFound() {
  return (
    ...
    >
      ...
      <h2 style={{ marginBottom: 0, fontSize: 16 }}>Not Found</h2>
      <p style={{ marginTop: 0 }}>This page doesn&apos;t exist or was moved.</p>

      <p>
        <Link href="/public" style={{ color: "#4c94fe", textDecoration: "none" }}>
          Go home
        </Link>
      </p>
    </div>
