  ...
  return (
    <>
      <main className={styles.main}>
        ...
        {/*  <span> My dedicated server is approaching its end of life.</span>*/}
        {/*  <Link href={"/blog/server-eol"}>Learn more</Link>*/}
        {/*</div>*/}

        <p>
          {server?.body ?? "CLP holder and hobbyist web developer."}
        </p>
              ...
              >
                ...
                <defs>
                  <linearGradient id="A" x2="50%" x1="50%" y2="100%" y1="0%">
                    <stop stopColor="#111d2e" offset="0%"></stop>
                    <stop stopColor="#051839" offset="21.2%"></stop>
                    <stop stopColor="#0a1b48" offset="40.7%"></stop>
                    <stop stopColor="#132e62" offset="58.1%"></stop>
                    <stop stopColor="#144b7e" offset="73.8%"></stop>
                    <stop stopColor="#136497" offset="87.3%"></stop>
                    <stop stopColor="#1387b8" offset="100%"></stop>
                  </linearGradient>
                </defs>
              </svg>
            </div>
        ...
        <div className={styles.friendsList}>
          ...
          <Link className={styles.addFriend} href="/share">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 16 16"
              width="16"
