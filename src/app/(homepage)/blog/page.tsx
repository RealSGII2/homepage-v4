...
function BlogPost({
  ...
  return (
    <Link href={"/blog/" + slug} className={styles.postItem}>
      <p>{title}</p>
      <p>
        Posted{" "}
...
export default function BlogHome() {
  return (
    ...
    >
      ...
      <BlogPost
        title="Server End of Life"
        slug="server-eol"
        date={1773771585340}
      >
        Not exactly a blog post, but still an important update. My dedicated
        server is shutting down the 17th of May 2026, which will take my
        dedicated game servers and serve.realsgii2.dev offline.
      </BlogPost>
